...
define Device/oboo-smart-clock
  DTS := Oboo-Clock
  IMAGE_SIZE := $(ralink_default_fw_size_32M)
  DEVICE_TITLE := Oboo Smart Clock
  DEVICE_PACKAGES:= kmod-usb2 kmod-usb-ohci uboot-envtools kmod-sdhci-mt7620
endef
TARGET_DEVICES += oboo-smart-clock

define Device/oboo-maker-clock
  DTS := Oboo-Clock-Maker
  IMAGE_SIZE := $(ralink_default_fw_size_32M)
  DEVICE_TITLE := Oboo Maker Clock
  DEVICE_PACKAGES:= kmod-usb2 kmod-usb-ohci uboot-envtools kmod-sdhci-mt7620
endef
TARGET_DEVICES += oboo-maker-clock
